...
export const forecastWeatherAPI = axios.create({
    ...
    params: {appid: hourlyForecast, units: 'metric', exclude: '[minutely,alerts,daily]'},
})

export const forecastDailyAPI = axios.create({
    baseURL: `api.openweathermap.org/data/2.5/forecast/daily`,
    params: {appid: hourlyForecast, units: 'metric', cnt: 8},
})